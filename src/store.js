...
const productsSlice = createSlice({
  ...
  initialState: {
    ...
    chocolate: [
      { name: "Amul Milk Chocolate Bar", price: 30.5, image: "/Chocolates/Amul Milk Chocolate Bar.jpg" },
      { name: "Cadbury 5 Star", price: 20.5, image: "/Chocolates/Cadbury 5 Star.jpg" },
      { name: "Cadbury Dairy Milk Silk", price: 20.5, image: "/Chocolates/Cadbury Dairy Milk Silk.jpg" },
      { name: "Cadbury Dairy Milk", price: 20.5, image: "/Chocolates/Cadbury Dairy Milk.jpg" },
      { name: "Dairy Milk Gems", price: 20.5, image: "/Chocolates/Dairy Milk Gems.jpg" },
      { name: "Munch", price: 20.5, image: "/Chocolates/Munch.jpg" },
      { name: "Perk", price: 20.5, image: "/Chocolates/Perk.jpg" },
      { name: "Munch Nuts", price: 20.5, image: "/Chocolates/Munch Nuts.jpg" },
    ],
  },
  reducers: {}
});
